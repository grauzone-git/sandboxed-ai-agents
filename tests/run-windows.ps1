...
foreach ($name in @('test-powershell.py', 'test-windows-cli.py', 'test-windows-update.py', 'test-windows-paths.py', 'test-capabilities.py', 'test-container-line-endings.py')) {
